                    ...
                    <v-container fluid>
                        <v-row align="center" justify="center">
                            <v-col cols="12" sm="3" md="6">
                                <h3 class="text-h6"><v-icon left>mdi-table</v-icon> Table Master</h3>
                            </v-col>
    ...
    data: () => ({
        ...
        methods:{
            dataTable(){
                this.headers = [
                    {text:'ID',value:'id'},
                    {text:'Observation List', value:'list'},
            ...
            addItem(){
                this.typeSubmit = 'add';
                this.dialog = true;
                this.titles = 'Tambah List Observasi'
            },
            editItem(){
                this.typeSubmit = 'edit';
                this.dialog = true;
                this.titles = 'Edit List Observasi'
            },
            deleteItem(){
                this.typeSubmit = 'delete';
                this.dialog1 = true;
                this.titles = 'Delete List Observasi';
                this.statment = 'Data';
            },
            reset(){
                this.formInput = {
